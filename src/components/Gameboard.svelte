...
<script>
    ...
    let fruits = ['katze1', 'katze2', 'katze3', 'katze4', 'katze5', 'katze6', 'katze7', 'katze8', 'katze9', 'katze10'];
  ...
  setTimeout(() => {
    ...
    function handleCardClick(clickedCard) {
        ...
        clickedCard.style.backgroundImage = 'url(src/img/' + clickedCard.id + '.png)';
